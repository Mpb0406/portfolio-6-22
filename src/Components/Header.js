...
const Header = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full transition duration-500 ease bg-cyan-500 shadow-md flex flex-col justify-start ${
        open ? "h-6/8" : "h-20"
      } md:flex-row md:items-center md:justify-between md:h-min duration-700`}>
